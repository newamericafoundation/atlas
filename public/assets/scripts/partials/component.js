...
(function () {
	...
	Comp.SideBar = (function (_React$Component) {
		_inherits(_class, _React$Component);
		...
		_createClass(_class, [{
			...
			value: function render() {
				return React.createElement(
					'div',
					{ className: this.getClass(), onClick: this.toggle.bind(this) },
					React.createElement(
						'div',
			...
			value: function renderButtons() {
				...
				var list = this.props.buttons.map(function (options, i) {
					return React.createElement(SideBarButton, _extends({}, _this.props, {
						options: options,
		...
		_createClass(SideBarButton, [{
			...
			value: function renderFormContent() {
				...
				return React.createElement(
					...
					React.createElement(IconComp, null),
					React.createElement('input', { type: 'hidden', name: this.props.options.hiddenInputKey, value: this.props.options.hiddenInputValue }),
...
Comp.Slider = (function (_React$Component) {
    _inherits(_class, _React$Component);
    ...
    _createClass(_class, [{
        key: 'render',
        value: function render() {
            return React.createElement('div', { className: 'atl__slider', ref: 'root' });
        }
    }, {
        ...
        value: function buildSlider() {
            ...
            $el.slider({
                ...
                slide: function slide(e, ui) {
                    ...
                    _this.props.setUiState({ currentSpecifier: _this.getSliderValueText() });
                }
            });
            this.setSliderValueText();
        }
...
Comp.Form = (function (_React$Component) {
	_inherits(_class, _React$Component);
...
Comp.Form.SelectizeText = (function (_React$Component) {
	_inherits(_class, _React$Component);
...
Comp.Form.SpreadsheetFile = (function (_React$Component) {
	_inherits(_class, _React$Component);
...
Comp.Form.Text = (function (_React$Component) {
	_inherits(_class, _React$Component);
		...
		_createClass(_class, [{
			...
			value: function render() {
				return React.createElement(
					...
					React.createElement(Comp.SideBar, { buttons: defaultButtons }),
					React.createElement(
						'div',
...
Comp.Projects.Show.Tilemap = (function (_React$Component) {
	_inherits(_class, _React$Component);
	...
	_createClass(_class, [{
		...
		key: 'renderBaseLayer',
		value: function renderBaseLayer() {
			return;
			return React.createElement('div', { className: 'atl__base-layer' });
		}
	}, {
		key: 'getActiveItem',
		...
		value: function componentWillMount() {
			...
			App.commands.setHandler('update:tilemap', function () {
				_this.forceUpdate();
			});
		}
	}]);
