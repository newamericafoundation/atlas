...
Comp.Icons.Dictionary = class extends React.Component {
	render() {
		return (
<svg viewBox="0 0 100 100">
<path d="M88.9,0H61.1C56.6,0,52.7,2.5,50,5.7C47.4,2.5,43.6,0,38.9,0H11.1C5,0,0,5,0,11.1v68.5
...
<g>
	...
	<polygon points="86.2,63.9 91,63.9 91,63.9 98.4,63.8 65.4,7.6 37.2,7.5 51.9,33.4 51.9,33.4 69.3,63.9 	"/>
